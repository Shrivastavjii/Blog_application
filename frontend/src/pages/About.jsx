...
function About() {
  ...
  console.log(profile);
  return (
    <div className="container mx-auto my-12 p-4 space-y-9 max-w-7xl">
      <h1 className="text-2xl font-bold mb-6">About</h1>
      <p>
        This is{" "}
        <strong className="text-red-800 font-semibold hover:scale-105 duration-500">
          {profile?.user?.name}
        </strong>{" "}
      ...
      <h2 className="font-semibold text-red-800 text-xl">
        Technical Expertise:
      </h2>
      <p>
